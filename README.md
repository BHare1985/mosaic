...
- Replace all occurrences of "Mosiac" in the relevant CMakeLists.txt with the name of your project
  - Capitalization matters here: `Mosiac` means the name of the project, while `mosiac` is used in file names.
  - Remember to rename the `include/mosiac` directory to use your project's lowercase name and update all relevant `#include`s accordingly.
